          ...
          <div className="pt-8">
            ...
            <div className="flex gap-4">
              ...
              <Button
                ...
                size="sm"
                variant="outline"
                className="hover-lift hover:border-secondary hover:text-primary"
              >
                <a
                  href="https://www.linkedin.com/in/tanay-mehto/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <Button
                ...
                size="sm"
                variant="outline"
                className="hover-lift hover:border-accent hover:text-primary"
              >
                <a
                  href="mailto:tanaymehto21@gmail.com"
                  target="_blank"
                  rel="noopener noreferrer"
                >
